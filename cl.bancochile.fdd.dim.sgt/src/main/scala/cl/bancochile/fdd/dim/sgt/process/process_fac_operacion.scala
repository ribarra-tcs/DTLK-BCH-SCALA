  ...
  */ 
  ...
  def process_master(huemulBigDataGov: huemul_BigDataGovernance, ControlParent: huemul_Control, param_year: Integer, param_month: Integer, param_day: Integer): Boolean = { 
    ...
    try {              
      ...
      /***************Crear Capa de dimension desde master para la tabla Fac_operacion **********************/ 
      Control.NewStep("Crear Capa de dimension desde master para la tabla Fac_operacion")
      ...
      /*************** Acceder Capa Master *********************/ 
      /*********************************************************/ 
      Control.NewStep("Acceder Capa Master") 
	...
	if (!huemulTable_tbl_fac_operacion.executeFull("DF_tbl_fac_operacion_Final")){ 
	     Control.RaiseError(s"Error al intentar cargar data de la table huemulTable_tbl_fac_operacion (${huemulTable_tbl_fac_operacion.Error_Code}): ${huemulTable_tbl_fac_operacion.Error_Text}") 
        } 
